...
public class Form_admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/user2.png"))); // NOI18N
        ...
        btnPelanggan.setBackground(new java.awt.Color(255, 255, 204));
        btnPelanggan.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnPelanggan.setText("Input Pelanggan");
        ...
        btnTransaksi.setBackground(new java.awt.Color(255, 255, 204));
        btnTransaksi.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        btnDist.setBackground(new java.awt.Color(255, 255, 204));
        btnDist.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnDist.setText("Input Distributor");
        ...
        jButton5.setText("Laporan Buku");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/logout.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnBuku, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE))
                        .addGap(74, 74, 74)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnBuku, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnPelanggan, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(52, 52, 52)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnTransaksi, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                    .addComponent(btnDist, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(41, 41, 41)
    ...
    private void btnPelangganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPelangganActionPerformed
        D_pelanggan db = new D_pelanggan();
        db.show();
        this.dispose();       
    }//GEN-LAST:event_btnPelangganActionPerformed

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        int a = JOptionPane.showConfirmDialog(null, "Logout?", "Informasi", JOptionPane.YES_NO_OPTION);
    ...
    private void btnDistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDistActionPerformed
        D_distributor db = new D_distributor();
        db.show();
        this.dispose();
    }//GEN-LAST:event_btnDistActionPerformed

    private void btnTransaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTransaksiActionPerformed
        form_beli db = new form_beli();
        db.show();
        this.dispose();
